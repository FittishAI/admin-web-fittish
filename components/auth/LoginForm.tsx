      ...
      <CardContent className="py-10 px-6 space-y-6">
        <div className="text-center">
          <div className="mb-4 flex justify-center">
            <div className="h-12 w-12 rounded-full flex items-center justify-center text-2xl"><FittishLogo width={64} height={64}/></div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              required
            />
            <div className="text-right font-Inter text-semibold text-sm text-blue-600 mt-1 cursor-pointer">Forgot password?</div>
          </div>
